...
! function (t) {
	...
	var t, e, n = (function (t, e) {
			! function (t, e) {
				var n, u, i = "function" == typeof Map ? new Map : (n = [], u = [], {
						has: function (t) {
						...
						set: function (t, e) {
							-1 === n.indexOf(t) && (n.push(t), u.push(e))
						},
						delete: function (t) {
							var e = n.indexOf(t);
							e > -1 && (n.splice(e, 1), u.splice(e, 1))
						}
					}),
					r = function (t) {
						return new Event(t, {
				...
				function s(t) {
					if (t && t.nodeName && "TEXTAREA" === t.nodeName && !i.has(t)) {
						var e = null,
							...
							a = function (e) {
								window.removeEventListener("resize", s, !1), t.removeEventListener("input", c, !1), t.removeEventListener("keyup", c, !1), t.removeEventListener("autosize:destroy", a, !1), t.removeEventListener("autosize:update", c, !1), Object.keys(e).forEach(function (n) {
									t.style[n] = e[n]
								}), i.delete(t)
							}.bind(t, {
						...
						t.addEventListener("autosize:destroy", a, !1), "onpropertychange" in t && "oninput" in t && t.addEventListener("keyup", c, !1), window.addEventListener("resize", s, !1), t.addEventListener("input", c, !1), t.addEventListener("autosize:update", c, !1), t.style.overflowX = "hidden", t.style.wordWrap = "break-word", i.set(t, {
							destroy: a,
							update: c
						}), "vertical" === (o = window.getComputedStyle(t, null)).resize ? t.style.resize = "none" : "both" === o.resize && (t.style.resize = "horizontal"), e = "content-box" === o.boxSizing ? -(parseFloat(o.paddingTop) + parseFloat(o.paddingBottom)) : parseFloat(o.borderTopWidth) + parseFloat(o.borderBottomWidth), isNaN(e) && (e = 0), c()
					}
					var o;
					...
					function h() {
						if (0 !== t.scrollHeight) {
							...
							t.style.height = "", t.style.height = t.scrollHeight + e + "px", n = t.clientWidth, u.forEach(function (t) {
					...
					function c() {
						...
						if (i < e ? "hidden" === n.overflowY && (l("scroll"), h(), i = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(t, null).height)) : t.offsetHeight) : "hidden" !== n.overflowY && (l("hidden"), h(), i = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(t, null).height)) : t.offsetHeight), u !== i) {
							u = i;
		...
		u = document.querySelectorAll('[data-toggle="autosize"]');
	...
	function v(t, e, n, u) {
		return (v = "undefined" != typeof Reflect && Reflect.set ? Reflect.set : function (t, e, n, u) {
			var i, r = p(t, e);
			if (r) {
	...
	function k(t, e, n, u, i) {
		if (!v(t, e, n, u || t) && i) throw new Error("failed to set property");
		return n
	}
	...
	var E = function () {
			function t(e, n, u, i) {
				for (r(this, t), this.value = e, this.cursorPos = n, this.oldValue = u, this.oldSelection = i; this.value.slice(0, this.startChangePos) !== this.oldValue.slice(0, this.startChangePos);) --this.oldSelection.start
			}
			return a(t, [{
				key: "startChangePos",
				get: function () {
		...
		C = function () {
			function t() {
				...
				r(this, t), this.value = e, this.from = n, this.stop = u
			}
			return a(t, [{
				key: "toString",
				value: function () {
	...
	var b = function () {
		...
		return a(t, [{
			...
			key: "appendTail",
			value: function (t) {
				return y(t) && (t = new C(String(t))), t.appendTo(this)
			}
		}, {
			key: "_appendCharRaw",
			value: function (t) {
				var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
				return (t = this.doPrepare(t, e)) ? (this._value += t, new A({
					inserted: t,
					rawInserted: t
				})) : new A
			}
			...
			value: function (t) {
				...
				if (i.inserted) {
					...
					s || (i = new A, this.state = u, n && r && (n.state = r))
				}
				return i
			}
		}, {
			...
			value: function (t, e, n) {
				if (!y(t)) throw new Error("value should be string");
				var u = new A,
					i = y(n) ? new C(String(n)) : n;
	...
	function S(t) {
		...
		return t instanceof RegExp ? F.MaskedRegExp : y(t) ? F.MaskedPattern : t instanceof Date || t === Date ? F.MaskedDate : t instanceof Number || "number" == typeof t || t === Number ? F.MaskedNumber : Array.isArray(t) || t === Array ? F.MaskedDynamic : F.Masked && t.prototype instanceof F.Masked ? t : t instanceof Function ? F.MaskedFunction : t instanceof F.Masked ? t.constructor : (console.warn("Mask not found for mask", t), F.Masked)
	}
	...
	var D = {
		...
		B = function () {
			...
			return a(t, [{
				...
				value: function () {
					var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
						e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length;
					return 0 === t && e >= 1 ? (this._isFilled = !1, this.masked.remove(t, e)) : new A
				}
			}, {
				key: "_appendChar",
				value: function (t) {
					var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
					if (this._isFilled) return new A;
		...
		T = function () {
			...
			return a(t, [{
				...
				value: function (e) {
					if (String(e)) {
						y(e) && (e = new C(String(e)));
						var n = this.chunks[this.chunks.length - 1],
							u = n && (n.stop === e.stop || null == e.stop) && e.from === n.from + n.toString().length;
						if (e instanceof C) u ? n.extend(e.toString()) : this.chunks.push(e);
				...
				key: "appendTo",
				value: function (e) {
					if (!(e instanceof F.MaskedPattern)) return new C(this.toString()).appendTo(e);
					for (var n = new A, u = 0; u < this.chunks.length && !n.skip; ++u) {
						var i = this.chunks[u],
							r = e._mapPosToBlock(e.value.length),
							s = i.stop,
							a = void 0;
						if (null != s && (!r || r.index <= s) && ((i instanceof t || e._stops.indexOf(s) >= 0) && n.aggregate(e._appendPlaceholder(s)), a = i instanceof t && e._blocks[s]), a) {
		...
		P = function (t) {
			function e() {
				return r(this, e), d(this, l(e).apply(this, arguments))
			}
			return o(e, b), a(e, [{
				key: "_update",
				value: function (t) {
					...
					}), f(l(e.prototype), "_update", this).call(this, t)
				}
			}]), e
		}();
	F.MaskedRegExp = P;
	var O = function (t) {
		function e() {
			...
			return r(this, e), t.definitions = Object.assign({}, D, t.definitions), d(this, l(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))
		}
		return o(e, b), a(e, [{
			key: "_update",
			value: function () {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				t.definitions = Object.assign({}, this.definitions, t.definitions), f(l(e.prototype), "_update", this).call(this, t), this._rebuildMask()
			}
		}, {
			key: "_rebuildMask",
			value: function () {
			...
			key: "reset",
			value: function () {
				f(l(e.prototype), "reset", this).call(this), this._blocks.forEach(function (t) {
					return t.reset()
				})
			}
		}, {
			...
			value: function () {
				this._blocks.forEach(function (t) {
					return t.doCommit()
				}), f(l(e.prototype), "doCommit", this).call(this)
			}
		}, {
			key: "appendTail",
			value: function (t) {
				return f(l(e.prototype), "appendTail", this).call(this, t).aggregate(this._appendPlaceholder())
			}
		}, {
			key: "_appendCharRaw",
			value: function (t) {
			...
			value: function () {
				...
				return e === n ? u : (this._forEachBlocksInRange(e, n, function (e, n, i, r) {
					...
					s.stop = t._findStopBefore(n), s.from = t._blockStartPos(n), s instanceof T && (s.blockIndex = n), u.extend(s)
				}), u)
			}
		}, {
			key: "extractInput",
			...
			value: function () {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
					n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
					u = f(l(e.prototype), "remove", this).call(this, t, n);
			...
			value: function (t) {
				...
				if (!(0 === s) && !a) return this._blockStartPos(i) + s;
				var o = a ? i + 1 : i;
				if (e === m.NONE) {
					if (o > 0) {
						var l = o - 1,
				...
				if (e === m.LEFT || e === m.FORCE_LEFT) {
					for (var y, _ = o; _ < this._blocks.length; ++_)
						...
						var E = this._blocks[y],
							A = E.nearestInputPos(0, m.RIGHT);
						if (0 === A && E.unmaskedValue.length) return this._blockStartPos(y) + A
					}
					for (var C, F = -1, b = o - 1; b >= 0; --b) {
						var S = this._blocks[b],
							w = S.nearestInputPos(S.value.length, m.FORCE_LEFT);
						if (S.value && 0 === w || (C = b), 0 !== w) {
							if (w !== S.value.length) return this._blockStartPos(b) + w;
							F = b;
							break
						}
					}
					if (e === m.LEFT)
						for (var D = F + 1; D <= Math.min(o, this._blocks.length - 1); ++D) {
							var B = this._blocks[D],
								x = B.nearestInputPos(0, m.NONE),
								T = this._blockStartPos(D) + x;
							if (T > t) break;
							if (x !== B.value.length) return T
						}
					...
					for (var P = o; P < this._blocks.length; ++P) {
						...
						if (!O.value.length || M !== O.value.length) return this._blockStartPos(P) + M
					}
					return 0
				}
				if (e === m.RIGHT || e === m.FORCE_RIGHT) {
					...
					if (null != I && null != R) {
						for (var j = I; j < this._blocks.length; ++j) {
							...
							if (H !== z.value.length) return this._blockStartPos(j) + H
						}
			...
			key: "state",
			get: function () {
				return Object.assign({}, f(l(e.prototype), "state", this), {
			...
			set: function (t) {
				...
				this._blocks.forEach(function (t, e) {
					return t.state = n[e]
				}), k(l(e.prototype), "state", u, this, !0)
			}
		}, {
			key: "isComplete",
			get: function () {
			...
			set: function (t) {
				k(l(e.prototype), "unmaskedValue", t, this, !0)
			}
		}, {
			key: "value",
			get: function () {
			...
			set: function (t) {
				k(l(e.prototype), "value", t, this, !0)
			}
		}]), e
	}();
	O.DEFAULTS = {
		lazy: !0,
		placeholderChar: "_"
	}, O.STOP_CHAR = "`", O.ESCAPE_CHAR = "\\", O.InputDefinition = B, O.FixedDefinition = x, F.MaskedPattern = O;
	var M = function (t) {
		function e() {
			return r(this, e), d(this, l(e).apply(this, arguments))
		}
		return o(e, O), a(e, [{
			...
			value: function (t) {
				...
				t.mask = i.slice(0, r).replace(/0/g, "\\0") + "0".repeat(n - r), f(l(e.prototype), "_update", this).call(this, t)
			}
		}, {
			key: "boundaries",
			value: function (t) {
			...
			value: function (t) {
				...
				if (t = f(l(e.prototype), "doPrepare", this).call(this, t, n).replace(/\D/g, ""), !this.autofix) return t;
				for (var u = String(this.from).padStart(this.maxLength, "0"), i = String(this.to).padStart(this.maxLength, "0"), r = this.value, s = "", a = 0; a < t.length; ++a) {
					var o = r + s + t[a],
						h = g(this.boundaries(o), 2),
						c = h[0],
						d = h[1];
					Number(d) < this.from ? s += u[o.length - 1] : Number(c) > this.to ? s += i[o.length - 1] : s += t[a]
				}
				return s
			}
		}, {
			...
			value: function () {
				...
				for (var u = g(this.boundaries(n), 2), i = u[0], r = u[1], s = arguments.length, a = new Array(s), o = 0; o < s; o++) a[o] = arguments[o];
				return this.from <= Number(r) && Number(i) <= this.to && (t = f(l(e.prototype), "doValidate", this)).call.apply(t, [this].concat(a))
			}
		}, {
			key: "_matchFrom",
			get: function () {
			...
			key: "isComplete",
			get: function () {
				return f(l(e.prototype), "isComplete", this) && Boolean(this.value)
			}
		}]), e
	}();
	F.MaskedRange = M;
	var I = function (t) {
		function e(t) {
			return r(this, e), d(this, l(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))
		}
		return o(e, O), a(e, [{
			key: "_update",
			value: function (t) {
			...
			value: function () {
				...
				return (t = f(l(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i)) && (!this.isComplete || this.isDateExist(this.value) && null != n && (null == this.min || this.min <= n) && (null == this.max || n <= this.max))
			}
		}, {
			key: "isDateExist",
			value: function (t) {
			...
			key: "typedValue",
			get: function () {
				return this.isComplete ? f(l(e.prototype), "typedValue", this) : null
			},
			set: function (t) {
				k(l(e.prototype), "typedValue", t, this, !0)
			}
		}]), e
	}();
	I.DEFAULTS = {
	...
	var V = function (t) {
		function e(t) {
			var n;
			return r(this, e), (n = d(this, l(e).call(this))).input = t, n._handlers = {}, n
		}
		return o(e, R), a(e, [{
			key: "_unsafeSelect",
			value: function (t, e) {
	...
	F.HTMLContenteditableMaskElement = N;
	var L = function () {
		function t(e, n) {
		...
		return a(t, [{
			key: "maskEquals",
			value: function (t) {
				return null == t || t === this.masked.mask || t === Date && this.masked instanceof I
			}
		}, {
			key: "_bindEvents",
			value: function () {
					...
					r = ! function t(e, n) {
						...
						if (n && e && "object" === i(n) && "object" === i(e)) {
							var a = n instanceof Date,
								o = e instanceof Date;
							if (a && o) return n.getTime() == e.getTime();
							if (a != o) return !1;
							...
							for (u = 0; u < c.length; u++)
								if (!Object.prototype.hasOwnProperty.call(e, c[u])) return !1;
							for (u = 0; u < c.length; u++)
								if (!t(e[c[u]], n[c[u]])) return !1;
							return !0
						}
			...
			set: function (t) {
				if (!this.maskEquals(t))
					if (t instanceof F.Masked || this.masked.constructor !== S(t)) {
						var e = w({
							mask: t
						});
	...
	var j = function (t) {
		...
		return o(e, O), a(e, [{
			key: "_update",
			value: function (t) {
				t.enum && (t.mask = "*".repeat(t.enum[0].length)), f(l(e.prototype), "_update", this).call(this, t)
			}
		}, {
			key: "doValidate",
			value: function () {
				...
				}) && (t = f(l(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i))
			}
		}]), e
	}();
	F.MaskedEnum = j;
	var z = function (t) {
		...
		return o(e, b), a(e, [{
			key: "_update",
			value: function (t) {
				f(l(e.prototype), "_update", this).call(this, t), this._updateRegExps()
			}
		}, {
			key: "_updateRegExps",
			value: function () {
				...
				this._numberRegExpInput = new RegExp(t + "(0|([1-9]+\\d*))?" + e), this._numberRegExp = new RegExp(t + "\\d*" + e), this._mapToRadixRegExp = new RegExp("[" + this.mapToRadix.map(_).join("") + "]", "g"), this._thousandsSeparatorRegExp = new RegExp(_(this.thousandsSeparator), "g")
			}
		}, {
			...
			value: function (t) {
				...
				return (n = f(l(e.prototype), "doPrepare", this)).call.apply(n, [this, this._removeThousandsSeparators(t.replace(this._mapToRadixRegExp, this.radix))].concat(i))
			}
		}, {
			...
			value: function () {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
					n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
					u = arguments.length > 2 ? arguments[2] : void 0,
					i = g(this._adjustRangeWithSeparators(t, n), 2);
				return t = i[0], n = i[1], this._removeThousandsSeparators(f(l(e.prototype), "extractInput", this).call(this, t, n, u))
			}
		}, {
			key: "_appendCharRaw",
			value: function (t) {
				var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
				if (!this.thousandsSeparator) return f(l(e.prototype), "_appendCharRaw", this).call(this, t, n);
				var u = n.tail && n._beforeTailState ? n._beforeTailState._value : this._value,
					i = this._separatorsCountFromSlice(u);
				this._value = this._removeThousandsSeparators(this.value);
				var r = f(l(e.prototype), "_appendCharRaw", this).call(this, t, n);
				this._value = this._insertThousandsSeparators(this._value);
				var s = n.tail && n._beforeTailState ? n._beforeTailState._value : this._value,
					a = this._separatorsCountFromSlice(s);
				return r.tailShift += (a - i) * this.thousandsSeparator.length, r.skip = !r.rawInserted && t === this.thousandsSeparator, r
			}
		}, {
				...
				switch (e) {
					...
					case m.FORCE_LEFT:
						...
						if (n >= 0) {
							...
							if (t < u || this.value.length <= u || e === m.FORCE_LEFT) return n
						}
						break;
					case m.RIGHT:
					case m.FORCE_RIGHT:
			...
			value: function (t) {
				...
				return n && f(l(e.prototype), "doValidate", this).call(this, t)
			}
		}, {
			key: "doCommit",
			value: function () {
			...
			set: function (t) {
				k(l(e.prototype), "unmaskedValue", t.replace(".", this.radix), this, !0)
			}
		}, {
			key: "typedValue",
			get: function () {
			...
			set: function (t) {
				k(l(e.prototype), "unmaskedValue", String(t), this, !0)
			}
		}, {
			key: "number",
			get: function () {
	...
	var H = function (t) {
		...
		return o(e, b), a(e, [{
			key: "_update",
			value: function (t) {
				t.mask && (t.validate = t.mask), f(l(e.prototype), "_update", this).call(this, t)
			}
		}]), e
	}();
	F.MaskedFunction = H;
	var U = function (t) {
		function e(t) {
			var n;
			return r(this, e), (n = d(this, l(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))).currentMask = null, n
		}
		return o(e, b), a(e, [{
			key: "_update",
			value: function (t) {
				f(l(e.prototype), "_update", this).call(this, t), "mask" in t && (this.compiledMasks = Array.isArray(t.mask) ? t.mask.map(function (t) {
					return w(t)
				}) : [])
			}
		}, {
			...
			value: function () {
				...
				return (t = f(l(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i)) && (!this.currentMask || (n = this.currentMask).doValidate.apply(n, i))
			}
		}, {
			key: "reset",
			value: function () {
			...
			value: function () {
				for (var t, n, u = arguments.length, i = new Array(u), r = 0; r < u; r++) i[r] = arguments[r];
				return this.currentMask ? (t = this.currentMask).extractTail.apply(t, i) : (n = f(l(e.prototype), "extractTail", this)).call.apply(n, [this].concat(i))
			}
		}, {
			key: "doCommit",
			value: function () {
				this.currentMask && this.currentMask.doCommit(), f(l(e.prototype), "doCommit", this).call(this)
			}
		}, {
			key: "nearestInputPos",
			value: function () {
				for (var t, n, u = arguments.length, i = new Array(u), r = 0; r < u; r++) i[r] = arguments[r];
				return this.currentMask ? (t = this.currentMask).nearestInputPos.apply(t, i) : (n = f(l(e.prototype), "nearestInputPos", this)).call.apply(n, [this].concat(i))
			}
		}, {
			key: "value",
			get: function () {
			...
			set: function (t) {
				var n = t.compiledMasks,
					u = t.currentMaskRef,
					i = t.currentMask,
					r = c(t, ["compiledMasks", "currentMaskRef", "currentMask"]);
				this.compiledMasks.forEach(function (t, e) {
					return t.state = n[e]
				}), null != u && (this.currentMask = u, this.currentMask.state = i), k(l(e.prototype), "state", r, this, !0)
			}
		}, {
			key: "overwrite",
			get: function () {
				return this.currentMask ? this.currentMask.overwrite : f(l(e.prototype), "overwrite", this)
			},
			set: function (t) {
	...
	function Y(t) {
		var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : G.MASKED,
	...
	F.PIPE_TYPE = G, F.createPipe = Y, F.pipe = function (t) {
		for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), u = 1; u < e; u++) n[u - 1] = arguments[u];
	...
	var q = ".dropdown, .dropup, .dropright, .dropleft",
		W = document.querySelectorAll(q),
		Z = void 0;
	W.forEach(function (t) {
		t.addEventListener("mousedown", function (t) {
			t.stopPropagation(), t.target.dataset.toggle && "dropdown" === t.target.dataset.toggle && (Z = t.currentTarget)
		}), t.addEventListener("hide.bs.dropdown", function (e) {
			e.stopPropagation();
			var n = Z ? Z.parentElement.closest(q) : void 0;
			n && n === t && e.preventDefault(), Z = void 0
		})
	...
	}), [].slice.call(document.querySelectorAll('[data-toggle="popover"]')).map(function (t) {
	...
	}), [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')).map(function (t) {
		return new bootstrap.Dropdown(t)
	}), [].slice.call(document.querySelectorAll('[data-toggle="switch-icon"]')).map(function (t) {
