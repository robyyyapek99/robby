...
<div class="form-group mb-3">
    <input type="text" readonly value="<?php echo $cabang['kode_cabang']; ?>" class="form-control" name="kodecabang" placeholder="Masukkan Kode Cabang">
</div>
<div class="form-group mb-3">
    <input type="text" value="<?php echo $cabang['nama_cabang']; ?>" class="form-control" name="namacabang" placeholder="Masukkan Nama Cabang">
</div>
<div class="form-group mb-3">
    <input type="text" value="<?php echo $cabang['alamat_cabang']; ?>"class="form-control" name="alamatcabang" placeholder="Masukkan Alamat Cabang">
</div>
<div class="form-group mb-3">
    <input type="text" value="<?php echo $cabang['telepon']; ?>"class="form-control" name="telepon" placeholder="Masukkan Telepon Cabang">
</div>
<div class="mb-3">
